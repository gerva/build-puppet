...
class buildmaster::settings {
    ...
    $mac_mac_dep1_signing_host = $::config::secrets::mac_mac_dep1_signing_host
    $mac_mac_dep1_signing_port = $::config::secrets::mac_mac_dep1_signing_port
    $mac_mac_dep1_signing_username = $::config::secrets::mac_mac_dep1_signing_username
    $mac_mac_dep1_signing_password = $::config::secrets::mac_mac_dep1_signing_password
    $mac_mac_dep2_signing_host = $::config::secrets::mac_mac_dep2_signing_host
    $mac_mac_dep2_signing_port = $::config::secrets::mac_mac_dep2_signing_port
    $mac_mac_dep2_signing_username = $::config::secrets::mac_mac_dep2_signing_username
    $mac_mac_dep2_signing_password = $::config::secrets::mac_mac_dep2_signing_password
